...
tf.flags.DEFINE_string('word_vector', '/home/vvs/Downloads/d_parse/models/multilingual_embeddings.ru', 'word vector')
...
data_test = load_data('/home/vvs/Downloads/d_parse/chinadataset/new_test_spect_ru.json', map_relations)
